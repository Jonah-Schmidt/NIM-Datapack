...
summon armor_stand ~ ~ ~ {Tags:["emote.new","emote.anim.shake","emote"],Marker:1b,Invulnerable:1b,ShowArms:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{id:"minecraft:leather_leggings",Count:1b},{id:"minecraft:leather_chestplate",Count:1b}],NoBasePlate:1b}

tellraw @s {"text": "No!","color": "blue"}
